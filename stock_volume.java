...
//
// Debug information:
// Generated date: Fri Dec 19 00:21:50 PST 2014
...
public class stock_volume extends SqoopRecord  implements DBWritable, Writable {
  ...
  private String total_stock_volume;
  public String get_total_stock_volume() {
    return total_stock_volume;
  }
  public void set_total_stock_volume(String total_stock_volume) {
    this.total_stock_volume = total_stock_volume;
  }
  public stock_volume with_total_stock_volume(String total_stock_volume) {
    this.total_stock_volume = total_stock_volume;
    return this;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.total_stock_volume = JdbcWritableBridge.readString(2, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(total_stock_volume, 2 + __off, 12, __dbStmt);
    return 2;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.total_stock_volume = Text.readString(__dataIn);
    }
  }
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.total_stock_volume) { 
        ...
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, total_stock_volume);
    }
  }
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("null")) { this.total_stock_volume = null; } else {
      this.total_stock_volume = __cur_str;
    }
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    if ("stock_symbol".equals(__fieldName)) {
      ...
      this.total_stock_volume = (String) __fieldVal;
    }
    else {
